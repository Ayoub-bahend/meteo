...
- **Nom** : `main`
- **Instance Type** : `c7i-flex.large` (x86_64, Intel-based)
...
| EC2 Instances (2x c7i-flex.large) | ~$144 | $0.10/heure × 2 × 24h × 30j |
...
| **Total** | **~$270-290/mois** | Environnement de développement |
