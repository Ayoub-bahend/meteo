...
node_instance_types = ["t3.medium"] # Type d'instances
```
...
- ✅ 1 NAT Gateway
- ✅ 1 Cluster EKS
- ✅ 1 Node Group avec 2 instances EC2 (t3.medium)
...
- **EC2 Instances (2x t3.medium)** : ~$0.0416/heure × 2 (~$60/mois)
